...
/**
 * Provides a generic Control over a Controller's rate. The graphical interface
 * is a simple rate TextField. When the user hits enter, the rate in the
 * TextField will be set in the Player.
 * 
 ...
 * 
 */
public class RateControl implements ActionListener, ControllerListener, Control {
