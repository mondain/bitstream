...
SET THE CLASSPATH: . ./env.sh (or execute env.bat if using MS Windows)
----------------------------------------------------------------------------------------------------------------------------
...
e.g. java jBittorrentAPI.ExampleCreateTorrent example/client1/funvideo.torrent http://localhost:8081/announce 256 example/client1/funvideo05.wmv .. "John Lynch" .. "this is a fun video"
----------------------------------------------------------------------------------------------------------------------------
PUBLISH TORRENT FILE: java jBittorrentAPI.ExamplePublish torrentPath <trackerUploadURL> <username> <password> <comment>

e.g. java jBittorrentAPI.ExamplePublish example/client1/funvideo.torrent http://localhost:8081/upload none none "this is a fun video"
----------------------------------------------------------------------------------------------------------------------------
SHARE TORRENT FILE: ExampleDownloadFiles <torrentPath>

e.g. java jBittorrentAPI.ExampleShareFiles example/client1/funvideo.torrent example/client1/
----------------------------------------------------------------------------------------------------------------------------
DOWNLOAD FILES: ExampleDownloadFiles <torrentPath>

e.g. java jBittorrentAPI.ExampleDownloadFiles example/client1/funvideo.torrent example/client1/
----------------------------------------------------------------------------------------------------------------------------
